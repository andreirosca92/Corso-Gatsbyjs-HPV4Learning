    ...
    <Layout>
      <div className={aboutStyle.page}>
        ...
        <p className={aboutStyle.text}>
          ...
          Nunc sollicitudin nunc id tortor tincidunt maximus. Donec commodo condimentum velit eu euismod. Nam viverra bibendum lobortis. 
          Vestibulum gravida dictum sapien. 
